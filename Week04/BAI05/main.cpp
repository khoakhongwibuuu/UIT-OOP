...
public:
    ...
    int getD() const { return this->DD; }
    int getM() const { return this->MM; }
    int getY() const { return this->YYYY; }
...
int main()
{
    ...
    cout << "Ngay " << d << " la " << d.getDayOfWeek() << endl;
    cout << "Ngay da nhap thuoc nam " << (d.isLeapYear(d.getY()) ? "" : "khong ") << "nhuan\n";
    d.addD(1);
    cout << "Ngay hom sau la " << d << endl;
    d.addD(-1);
    d.addM(-2);
    cout << "2 thang truoc la " << d << endl;
    d.addM(2);
    d.addY(3);
    cout << "3 nam sau la sau la " << d << endl;
    d.addY(-3);
